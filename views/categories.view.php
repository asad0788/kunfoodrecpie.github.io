            ...
            <div class="container-fluid padding-25 sm-padding-10">
                <div class="row">
                    ...
                    <div class="col-12" style="text-align: right;padding-right: 20px;">
                        <a class="btn btn-outline-dark" href="<?php echo SITE_URL ?>/controller/new_category.php">
        ...
        <?php foreach($categories as $category): ?>
            <tr>
              <td><?php echo $category['category_id']; ?></td>
                ...
                <td>
                <a href="../controller/edit_category.php?id=<?php echo $category['category_id']; ?>" style="font-size: 14px;color: #34495e;"><i class="fa fa-cog"></i></a>
          <a onclick="alertdelete_<?php echo $category['category_id']; ?>();" style="cursor: pointer;font-size: 14px;color: #34495e;"><i class="fa fa-trash-o"></i></a>
