...
<div class="form-row">
   ...
   <label>Image: <a href="<?php echo SITE_URL ?>/images/<?php echo $category['category_image']; ?>" data-lightbox="image-1">Preview</a></label><br/>
   
   <input type="hidden" value="<?php echo $category['category_image']; ?>" name="category_image_save">
   <div class="input-file-container">  
    <input class="input-file" name="category_image" id="my-file" type="file">
